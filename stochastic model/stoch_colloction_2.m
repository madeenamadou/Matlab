%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   stoch_collocation.m:  A Matlab program to solve a simple stochastic 
%   growth model using Collocation Method
%
...
temp2 = bsxfun(@times,(kgrid.^alpha),Z'); temp3 = bsxfun(@plus,temp2,(1-delta).*kgrid);
C = bsxfun(@plus,temp3,-Kp);
neg = C<0; C(neg) = 1e-6;
util(neg) = -1e12;
